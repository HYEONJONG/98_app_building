...
#=====================================================================
# get historical data from yahoo_fin
#=====================================================================
stock="SPY"
...
get_postmarket_price(stock) # if available / applicable

pp(get_quote_data(stock)) # Scrapes a collection of over 70 data points for an input ticker from Yahoo Finance
pp(get_quote_table(stock)) # Scrapes the primary table
pp(get_stats(stock)) # Primary statistics
(get_stats_valuation(stock)) # Primary statistics
